...
router.get('/v9/1-initial-set-up/starting-a-new-application', function (req, res) {
  // Set URl
  res.render('v9/1-initial-set-up/starting-a-new-application', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/1-initial-set-up/starting-a-new-application', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['newApplication'] === 'undefined') {
    ...
    if (req.session.data['newApplication'] === 'yes') {
      res.redirect('/v9/1-initial-set-up/check-before')
    } 
  }
})

// ******* check-before javascript ********************************
router.get('/v9/1-initial-set-up/check-before', function (req, res) {
  // Set URl
  res.render('v9/1-initial-set-up/check-before', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/1-initial-set-up/check-before', function (req, res) {
  res.redirect('/v9/1-initial-set-up/have-you-verified')
})

// ******* Sign in email validation ********************************
router.get('/v9/1-initial-set-up/sign-in-email', function (req, res) {
  // Set URl
  res.render('v9/1-initial-set-up/sign-in-email', {
    currentUrl: req.originalUrl
  })
})
...
router.get('/v9/1-initial-set-up/have-you-verified', function (req, res) {
  // Set URl
  res.render('v9/1-initial-set-up/have-you-verified', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/1-initial-set-up/have-you-verified', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['haveVerified'] === 'undefined') {
    ...
    if (req.session.data['haveVerified'] === 'yes') {
      res.redirect('/v9/1-initial-set-up/card-or-paypal')
    } else {
      // User inputted value so move to next page
      res.redirect('/v9/1-initial-set-up/verification-stop')
    }
  }
})
...
router.get('/v9/1-initial-set-up/card-or-paypal', function (req, res) {
  // Set URl
  res.render('v9/1-initial-set-up/card-or-paypal', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/1-initial-set-up/card-or-paypal', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['paypal'] === 'undefined') {
    ...
    if (req.session.data['paypal'] === 'yes') {
      res.redirect('/v9/1-initial-set-up/secure-register')
    } else {
      // User inputted value so move to next page
      res.redirect('/v9/1-initial-set-up/card-or-paypal-stop')
    }
  }
})
...
router.get('/v9/1-initial-set-up/secure-register', function (req, res) {
  // Set URl
  res.render('v9/1-initial-set-up/secure-register', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/1-initial-set-up/secure-register', function (req, res) {
  // Create empty array
  var errors = []
...
router.get('/v9/2-company-details/company-relationship', function (req, res) {
  // Set URl
  res.render('v9/2-company-details/company-relationship', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/2-company-details/company-relationship', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['companyRelationship'] === 'undefined') {
    ...
    res.redirect('/v9/2-company-details/company-name')
  }
})


// ******* company-name javascript ******************************
router.get('/v9/2-company-details/company-name', function (req, res) {
  // Set URl
  res.render('v9/2-company-details/company-name', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/2-company-details/company-name', function (req, res) {
  ...
  if (companyNameError) {
    ...
    res.redirect('/v9/3-director/set-up-directors')
  }
...
router.get('/v9/3-director/set-up-directors', function (req, res) {
  // Set URl
  res.render('v9/3-director/set-up-directors', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/3-director/set-up-directors', function (req, res) {
  res.redirect('/v9/3-director/director-details')
})


// ******* director-details javascript ******************************
router.get('/v9/3-director/director-details', function (req, res) {
  // Set URl
  res.render('v9/3-director/director-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/3-director/director-details', function (req, res) {
  // Create empty array and set error variables to false
  var errors = []
  ...
  if (detailsError) {
    ...
    res.redirect('/v9/3-director/director-name-different')
  } else {
    res.redirect('/v9/3-director/director-address')
  }
})


// ******* director-name-different' javascript ********************************
router.get('/v9/3-director/director-name-different', function (req, res) {
  // Set URl
  res.render('v9/3-director/director-name-different', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/3-director/director-name-different', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['nameDifferent'] === 'undefined') {
    ...
    if (req.session.data['nameDifferent'] === 'yes') {
      res.redirect('/v9/3-director/director-why-this-name')
    } else {
      // User inputted value so move to next page
      res.redirect('/v9/3-director/director-details')
    }
...
router.get('/v9/3-director/director-why-this-name', function (req, res) {
  // Set URl
  res.render('v9/3-director/director-why-this-name', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/3-director/director-why-this-name', function (req, res) {
  res.redirect('/v9/3-director/director-address')
})


// ******* director-address javascript ********************************
router.get('/v9/3-director/director-address', function (req, res) {
  // Set URl
  res.render('v9/3-director/director-address', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/3-director/director-address', function (req, res) {
  res.redirect('/v9/3-director/director-confirm-address')
})


// ******* confirm-address javascript ********************************
router.get('/v9/3-director/director-confirm-address', function (req, res) {
  // Set URl
  res.render('v9/3-director/director-confirm-address', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/3-director/director-confirm-address', function (req, res) {
  res.redirect('/v9/3-director/director-statement')
})


// ******* director-statement javascript ********************************
router.get('/v9/3-director/director-statement', function (req, res) {
  // Set URl
  res.render('v9/3-director/director-statement', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/3-director/director-statement', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['directorStatement'] === 'undefined') {
    ...
    res.render('v9/3-director/director-statement', {
      ...
      res.redirect('/v9/3-director/director-add')
  }
})


// ******* add-director javascript ********************************
router.get('/v9/3-director/director-add', function (req, res) {
  // Set URl
  res.render('v9/3-director/director-add', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/3-director/director-add', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['anotherDirector'] === 'undefined') {
    ...
    res.redirect('/v9/3-director/director-check-details')
  } 
})


// ******* check-director-details javascript ******************************
router.get('/v9/3-director/director-check-details', function (req, res) {
  // Set URl
  res.render('v9/3-director/director-check-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/3-director/director-check-details', function (req, res) {
    // Create empty array and set error variables to false
    var errors = []
  ...
  if (directorDetailsError) {
    ...
    res.redirect('/v9/4-shareholders/set-up-shareholders')
  }
  
})

// ******* set-up-shareholders javascript ******************************
router.get('/v9/4-shareholders/set-up-shareholders', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/set-up-shareholders', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/set-up-shareholders', function (req, res) {
  res.redirect('/v9/4-shareholders/is-a-shareholder')
})

// ******* add-shareholder javascript ********************************
router.get('/v9/4-shareholders/is-a-shareholder', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/is-a-shareholder', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/is-a-shareholder', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['isShareholder'] === 'undefined') {
    ...
    res.redirect('/v9/4-shareholders/shareholder-add')
  } 
})


// ******* add-shareholder javascript ********************************
router.get('/v9/4-shareholders/shareholder-add', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/shareholder-add', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/shareholder-add', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['addShareholder'] === 'undefined') {
    ...
    res.redirect('/v9/4-shareholders/shareholder-type')
  } else {
    res.redirect('/v9/4-shareholders/check-shareholder-details')
  }
})


// ******* add-shareholder javascript ********************************
router.get('/v9/4-shareholders/shareholder-type', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/shareholder-type', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/shareholder-type', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['typeShareholder'] === 'undefined') {
    ...
    res.redirect('/v9/4-shareholders/shareholder-name')
  } else {
    res.redirect('/v9/4-shareholders/corporate-shareholder-name')
  }
})


// ******* shareholder-name javascript *********************
router.get('/v9/4-shareholders/shareholder-name', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/shareholder-name', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/shareholder-name', function (req, res) {
  // Create empty array and set error variables to false
  var errors = [];
  var firstNameError = false
  var lastNameError = false
  ...
  res.render('v9/4-shareholders/shareholder-name', {
    ...
    errorList: errors
      ...
      res.redirect('/v9/4-shareholders/shareholder-address')
    }
})


// ******* shareholder-address javascript ********************************
router.get('/v9/4-shareholders/shareholder-address', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/shareholder-address', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/shareholder-address', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['shareholderAddress'] === 'undefined') {
    ...
    res.redirect('/v9/4-shareholders/shareholder-address-2')
  }
})


// ******* shareholder-address2 javascript ********************************
router.get('/v9/4-shareholders/shareholder-address-2', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/shareholder-address-2', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/shareholder-address-2', function (req, res) {
    res.redirect('/v9/4-shareholders/shareholder-confirm-address')
})


// ******* confirm-address javascript ********************************
router.get('/v9/4-shareholders/shareholder-confirm-address', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/shareholder-confirm-address', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/shareholder-confirm-address', function (req, res) {
  res.redirect('/v9/4-shareholders/shareholder-add')
})


// ******* corporate-shareholder-name javascript *********************
router.get('/v9/4-shareholders/corporate-shareholder-name', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/corporate-shareholder-name', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/corporate-shareholder-name', function (req, res) {
  // Create empty array and set error variables to false
  var errors = [];
  var nameError = false
  ...
  res.render('v9/4-shareholders/corporate-shareholder-name', {
    ...
    errorList: errors
      ...
      res.redirect('/v9/4-shareholders/corporate-shareholder-name-warning')
    }
})


// ******* confirm-address javascript ********************************
router.get('/v9/4-shareholders/corporate-shareholder-name-warning', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/corporate-shareholder-name-warning', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/corporate-shareholder-name-warning', function (req, res) {
  res.redirect('/v9/4-shareholders/corporate-shareholder-address')
})



// ******* corporate-shareholder-address javascript ********************************
router.get('/v9/4-shareholders/corporate-shareholder-address', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/corporate-shareholder-address', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/corporate-shareholder-address', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['corporateShareholderAddress'] === 'undefined') {
    ...
    res.redirect('/v9/4-shareholders/corporate-shareholder-person')
  } else {
    res.redirect('/v9/4-shareholders/corporate-shareholder-address-2')
  }
})


// ******* corporate-shareholder-address2 javascript ********************************
router.get('/v9/4-shareholders/corporate-shareholder-address-2', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/corporate-shareholder-address-2', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/corporate-shareholder-address-2', function (req, res) {
    res.redirect('/v9/4-shareholders/corporate-shareholder-confirm-address')
})


// ******* corporate-confirm-address javascript ********************************
router.get('/v9/4-shareholders/corporate-shareholder-confirm-address', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/corporate-shareholder-confirm-address', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/corporate-shareholder-confirm-address', function (req, res) {
  res.redirect('/v9/4-shareholders/corporate-shareholder-person')
})


// ******* corporate-shareholder-person javascript *********************
router.get('/v9/4-shareholders/corporate-shareholder-person', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/corporate-shareholder-person', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/corporate-shareholder-person', function (req, res) {
  // Create empty array and set error variables to false
  var errors = [];
  var firstNameError = false
  var lastNameError = false
...
router.get('/v9/4-shareholders/check-shareholder-details', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/check-shareholder-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/check-shareholder-details', function (req, res) {
  res.redirect('/v9/4-shareholders/share-type')
})



// ******* share-type javascript ********************************
router.get('/v9/4-shareholders/share-type', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/share-type', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/share-type', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['shareType'] === 'undefined') {
    ...
    res.redirect('/v9/4-shareholders/share-number')
  } 
})


// ******* share-number javascript ********************************
router.get('/v9/4-shareholders/share-number', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/share-number', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/share-number', function (req, res) {
  res.redirect('/v9/4-shareholders/share-value')
})


// ******* share-type javascript ********************************
router.get('/v9/4-shareholders/share-value', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/share-value', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/share-value', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['shareValue'] === 'undefined') {
    ...
    res.redirect('/v9/4-shareholders/check-shares')
})


// ******* check-shares javascript ********************************
router.get('/v9/4-shareholders/check-shares', function (req, res) {
  // Set URl
  res.render('v9/4-shareholders/check-shares', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/4-shareholders/check-shares', function (req, res) {
  res.redirect('/v9/5-psc/set-up-pscs')
})


// ******* set-up-pscs javascript ******************************
router.get('/v9/5-psc/set-up-pscs', function (req, res) {
  // Set URl
  res.render('v9/5-psc/set-up-pscs', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/set-up-pscs', function (req, res) {
  res.redirect('/v9/5-psc/director-psc/psc-previous-answers')
})


// ******* director-psc/psc-previous-answers javascript ******************************
router.get('/v9/5-psc/director-psc/psc-previous-answers', function (req, res) {
  // Set URl
  res.render('v9/5-psc/director-psc/psc-previous-answers', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/director-psc/psc-previous-answers', function (req, res) {
  res.redirect('/v9/5-psc/director-psc/psc-right-to-appoint')
})


// ******* director-psc/psc-right-to-appoint javascript ********************************
router.get('/v9/5-psc/director-psc/psc-right-to-appoint', function (req, res) {
  // Set URl
  res.render('v9/5-psc/director-psc/psc-right-to-appoint', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/director-psc/psc-right-to-appoint', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['rightAppoint'] === 'undefined') {
    ...
    res.redirect('/v9/5-psc/individual-psc/psc-previous-answers')
  } // Check if corporate shareholder filled out
  else if (req.session.data['shareholderCorporateName']){
    res.redirect('/v9/5-psc/corporate-psc/rle-previous-answers')
  } else
  {
    res.redirect('/v9/5-psc/psc-check-details')
  }
})


// ******* individual-psc/psc-previous-answers javascript ******************************
router.get('/v9/5-psc/individual-psc/psc-previous-answers', function (req, res) {
  // Set URl
  res.render('v9/5-psc/individual-psc/psc-previous-answers', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/individual-psc/psc-previous-answers', function (req, res) {
  res.redirect('/v9/5-psc/individual-psc/psc-details')
})


// ******* individual-psc/psc-right-to-appoint javascript ********************************
router.get('/v9/5-psc/individual-psc/psc-right-to-appoint', function (req, res) {
  // Set URl
  res.render('v9/5-psc/individual-psc/psc-right-to-appoint', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/individual-psc/psc-right-to-appoint', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['individualRightAppoint'] === 'undefined') {
    ...
    res.render('v9/5-psc/individual-psc/psc-right-to-appoint', {
      ...
      res.redirect('/v9/5-psc/individual-psc/psc-statement')
    }
})


// ******* psc-statement javascript ********************************
router.get('/v9/5-psc/individual-psc/psc-statement', function (req, res) {
  // Set URl
  res.render('v9/5-psc/individual-psc/psc-statement', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/individual-psc/psc-statement', function (req, res) {
  // Create empty array
  var errors = []
...
router.get('/v9/5-psc/individual-psc/psc-details', function (req, res) {
  // Set URl
  res.render('v9/5-psc/individual-psc/psc-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/individual-psc/psc-details', function (req, res) {
    // Create empty array and set error variables to false
    var errors = []
    var firstNameError = false
    var lastNameError = false
  ...
  if (detailsError) {
    ...
    res.redirect('/v9/5-psc/individual-psc/psc-name-different')
  } else {
    res.redirect('/v9/5-psc/individual-psc/psc-right-to-appoint')
  }
})


// ******* psc-name-different' javascript ********************************
router.get('/v9/5-psc/individual-psc/psc-name-different', function (req, res) {
  // Set URl
  res.render('v9/5-psc/individual-psc/psc-name-different', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/individual-psc/psc-name-different', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['pscNameDifferent'] === 'undefined') {
    ...
    if (req.session.data['pscNameDifferent'] === 'yes') {
      res.redirect('/v9/5-psc/individual-psc/psc-why-this-name')
    } else {
      // User inputted value so move to next page
      res.redirect('/v9/5-psc/individual-psc/psc-details')
    }
...
router.get('/v9/5-psc/individual-psc/psc-why-this-name', function (req, res) {
  // Set URl
  res.render('v9/5-psc/individual-psc/psc-why-this-name', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/individual-psc/psc-why-this-name', function (req, res) {
  res.redirect('/v9/5-psc/individual-psc/psc-right-to-appoint')
})


// ******* corporate-psc/psc-previous-answers javascript ******************************
router.get('/v9/5-psc/corporate-psc/psc-previous-answers', function (req, res) {
  // Set URl
  res.render('v9/5-psc/corporate-psc/psc-previous-answers', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/corporate-psc/psc-previous-answers', function (req, res) {
  res.redirect('/v9/5-psc/corporate-psc/rle-details')
})
...
// ******* add-psc javascript ********************************
router.get('/v9/5-psc/psc-add', function (req, res) {
  // Set URl
  res.render('v9/5-psc/psc-add', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/psc-add', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['addPsc'] === 'undefined') {
    ...
    if (req.session.data['addPsc'] === 'psc') {
      res.redirect('/v9/5-psc/psc-details')
    } else if (req.session.data['addPsc'] === 'rle') {
      res.redirect('/v9/5-psc/corporate-psc/rle-name')
    }
    }
})
...
// ******* check-director-details javascript ******************************
router.get('/v9/5-psc/psc-check-details', function (req, res) {
  // Set URl
  res.render('v9/5-psc/psc-check-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/psc-check-details', function (req, res) {
    // Create empty array and set error variables to false
    var errors = []
    var directorDetailsError = false
...
router.get('/v9/5-psc/psc-why-this-name', function (req, res) {
  // Set URl
  res.render('v9/5-psc/psc-why-this-name', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/psc-why-this-name', function (req, res) {
  res.redirect('/v9/5-psc/psc-address')
})


// ******* psc-address javascript ********************************
router.get('/v9/5-psc/psc-address', function (req, res) {
  // Set URl
  res.render('v9/5-psc/psc-address', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/psc-address', function (req, res) {
  res.redirect('/v9/5-psc/psc-confirm-address')
})


// ******* psc-confirm-address javascript ********************************
router.get('/v9/5-psc/psc-confirm-address', function (req, res) {
  // Set URl
  res.render('v9/5-psc/psc-confirm-address', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/psc-confirm-address', function (req, res) {
  res.redirect('/v9/5-psc/psc-right-to-appoint')
})



// ******* individual-psc/psc-previous-answers javascript ******************************
router.get('/v9/5-psc/corporate-psc/rle-previous-answers', function (req, res) {
  // Set URl
  res.render('v9/5-psc/corporate-psc/rle-previous-answers', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/corporate-psc/rle-previous-answers', function (req, res) {
  res.redirect('/v9/5-psc/corporate-psc/rle-registered')
})


// ******* rle-details javascript ******************************
router.get('/v9/5-psc/corporate-psc/rle-details', function (req, res) {
  // Set URl
  res.render('v9/5-psc/corporate-psc/rle-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/corporate-psc/rle-details', function (req, res) {
    // Create empty array and set error variables to false
    var errors = []
  ...
  if (detailsError) {
    ...
    res.redirect('/v9/5-psc/corporate-psc/rle-right-to-appoint')
  }
})
...
router.get('/v9/5-psc/corporate-psc/rle-registered', function (req, res) {
  // Set URl
  res.render('v9/5-psc/corporate-psc/rle-registered', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/corporate-psc/rle-registered', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['rleRegistered'] === 'undefined') {
    ...
    res.render('v9/5-psc/corporate-psc/rle-registered', {
      ...
      errorList: errors
       ...
       res.redirect('/v9/5-psc/corporate-psc/rle-corporate-body')}
})


// ******* rle-corporate-body javascript ********************************
router.get('/v9/5-psc/corporate-psc/rle-corporate-body', function (req, res) {
  // Set URl
  res.render('v9/5-psc/corporate-psc/rle-corporate-body', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/corporate-psc/rle-corporate-body', function (req, res) {
  // Create empty array
  var errors = []
...
router.get('/v9/5-psc/corporate-psc/ro-right-to-appoint', function (req, res) {
  // Set URl
  res.render('v9/5-psc/corporate-psc/ro-right-to-appoint', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/corporate-psc/rle-right-to-appoint', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['rleRightAppoint'] === 'undefined') {
    ...
    // Re-show page with error value as true so errors will show
    res.render('v9/5-psc/corporate-psc/rle-right-to-appoint', {
      errorRleRightAppoint: true,
      errorList: errors
    })
  } else {
      res.redirect('/v9/5-psc/corporate-psc/ro-details')
    }
})
...
router.get('/v9/5-psc/corporate-psc/ro-details', function (req, res) {
  // Set URl
  res.render('v9/5-psc/corporate-psc/ro-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/corporate-psc/ro-details', function (req, res) {
  // Create empty array and set error variables to false
  var errors = [];
  var firstNameError = false
  var lastNameError = false
  ...
  res.render('v9/5-psc/corporate-psc/ro-details', {
    ...
    if (req.session.data['roPersonalCode'] === '111-2222-3333') {
      res.redirect('/v9/5-psc/corporate-psc/ro-name-different')
    } 
    // dob code mis-match
      ...
      res.redirect('/v9/5-psc/corporate-psc/ro-statements')
    }
  }
})
...
// ******* psc-name-different' javascript ********************************
router.get('/v9/5-psc/corporate-psc/ro-name-different', function (req, res) {
  // Set URl
  res.render('v9/5-psc/corporate-psc/ro-name-different', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/corporate-psc/ro-name-different', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['roNameDifferent'] === 'undefined') {
    ...
    if (req.session.data['roNameDifferent'] === 'yes') {
      res.redirect('/v9/5-psc/corporate-psc/ro-why-this-name')
    } else {
      // User inputted value so move to next page
      res.redirect('/v9/5-psc/corporate-psc/ro-details')
    }
...
router.get('/v9/5-psc/corporate-psc/ro-why-this-name', function (req, res) {
  // Set URl
  res.render('v9/5-psc/corporate-psc/ro-why-this-name', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/corporate-psc/ro-why-this-name', function (req, res) {
  res.redirect('/v9/5-psc/corporate-psc/ro-statements')
})


// ******* ro-statements javascript ********************************
router.get('/v9/5-psc/corporate-psc/ro-statements', function (req, res) {
  // Set URl
  res.render('v9/5-psc/corporate-psc/ro-statements', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/5-psc/corporate-psc/ro-statements', function (req, res) {
  var errors = [];
